...
## The purpose of this analysis is to aggregate multiple datasets into a single dataframe, then conduct simple analysis to answer the business question "In what ways do members and casual riders use bike share services differently?" for our stakeholders, Cyclistic's Marketing Analytics team and Executive team.
...
setwd("C:/Users/...") #Make sure to input your own directory path here!
getwd()
...
#### Verifying consistency of column names and datatypes
...
#### Aggregating all of the datasets into one dataframe for analysis
...
#### Creating a secondary single dataframe to manipulate data as save point in case of error

```{r creating secondary aggregated dataframe before editing data, warning=FALSE}
...
#### Saving Tibbles as dataframes for use in viz


```{r turning weekly tibble into a dataframe for later use}
...
```{r turning monthly tibble into a dataframe for later use}
...
#### Plotting the number of trips per month by user type


```{r number of trips per month}
all_trips_edited %>%
  group_by(user_type, weekday) %>%
  summarise(
    'number_of_rides' = n(),
...
#### Exporting a summary dataframe for visualization and presentation
